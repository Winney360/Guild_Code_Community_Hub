  ...
  return (
    <footer className="bg-white dark:bg-[#0e1719] border-t border-[#006655]/30 dark:border-[#00a88a]/40 dark:border-[#00a88a]/20 pt-12 pb-8 mt-auto select-none transition-colors sm:pt-14">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        {/* Main Columns Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-0 md:gap-10 pb-12 border-b border-[#006655]/30 dark:border-[#00a88a]/40 dark:border-[#00a88a]/20">
          {/* Col 1: Brand Info */}
          ...
          {/* Cols 2-4: Link columns (stacked on mobile, in one line on md+) */}
          <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 divide-y divide-[#006655]/15 dark:divide-[#00a88a]/20 md:divide-y-0 md:gap-10">
            {/* Col 2: Platform Links */}
            <div className="space-y-3 py-8 md:py-0">
        ...
        {/* Social Icons, Back to Top & Copyright */}
        <div className="pt-6 flex flex-col gap-6 md:pt-8 md:gap-4">
          {/* Social Icons (centered) + Back to Top */}
          <div className="flex flex-col items-center gap-6 md:flex-row md:items-center md:justify-between md:gap-4 pt-6 md:pt-0 border-t border-[#006655]/15 dark:border-[#00a88a]/20 md:border-t-0">
            {/* Social Links */}
          ...
          {/* Bottom Copyright */}
          <div className="text-center text-xs text-[#5c7075] dark:text-slate-400 pt-6 md:pt-0 border-t border-[#006655]/15 dark:border-[#00a88a]/20 md:border-t-0">
