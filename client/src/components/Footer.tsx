...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white dark:bg-[#0e1719] border-t border-slate-100 dark:border-[#1e2e30] pt-14 pb-8 mt-auto select-none transition-colors">
      <div className="max-w-7xl mx-auto px-6">
        {/* Main Columns Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-100 dark:border-[#1e2e30]">
          {/* Col 1: Brand Info */}
