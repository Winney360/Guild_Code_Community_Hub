...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-white border-b border-[#006655]/15 dark:border-[#00a88a]/20 sticky top-0 z-50">
      ...
      {/* Mobile Drawer */}
      {isOpen && (
        <div className="md:hidden border-t border-[#006655]/15 dark:border-[#00a88a]/20 bg-white px-6 py-4 flex flex-col gap-4 animate-fadeIn">
          <Link
            to="/"
