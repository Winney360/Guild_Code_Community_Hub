        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProjects.map((project) => (
            ...
            >
              <div>
                {/* Image & status */}
                <Link to={`/projects/${project._id}`} className="block relative aspect-[16/10] bg-slate-50 border-b border-[#006655]/30 dark:border-[#00a88a]/40 select-none overflow-hidden group">
              ...
              <div className="px-5 pb-5 pt-3 border-t border-[#006655]/30 dark:border-[#00a88a]/40 text-[9px] font-semibold text-slate-400 select-none flex items-center justify-between">
