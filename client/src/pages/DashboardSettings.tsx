...
export const DashboardSettings: React.FC = () => {
  ...
  return (
    <div className="space-y-8 font-sans text-[#091e22]">
      ...
      {toastMessage && (
        <div className="fixed top-6 left-1/2 -translate-x-1/2 z-[100] flex items-center gap-3 bg-white border border-[#006655]/15 dark:border-[#00a88a]/20 text-[#091e22] px-5 py-3 rounded-2xl shadow-xl text-xs font-bold animate-slide-in select-none dark:bg-[#121e21] dark:border-[#00a88a]/20 dark:text-[#f1f5f9]">
