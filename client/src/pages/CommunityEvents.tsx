          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {events.map((event) => (
              ...
              >
                ...
                <div className="border-t border-[#006655]/15 dark:border-[#00a88a]/20 pt-4 mt-auto flex items-center justify-between text-[10px] text-[#5c7075] select-none font-semibold">
