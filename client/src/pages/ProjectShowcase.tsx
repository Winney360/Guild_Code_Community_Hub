        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {paginatedProjects.map((project) => (
            ...
            >
              <div>
                {/* Project Cover Image */}
                <div className="block relative aspect-[16/9] w-full bg-slate-100 border-b border-[#006655]/30 dark:border-[#00a88a]/40 select-none overflow-hidden group">
                  <img
              ...
              {/* Owner Footer row */}
              <div className="px-6 pb-6 pt-3 border-t border-[#006655]/30 dark:border-[#00a88a]/40 flex items-center justify-between text-xs text-[#5c7075] select-none">
                {/* Author Info */}
