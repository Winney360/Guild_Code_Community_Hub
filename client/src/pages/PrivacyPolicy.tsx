    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-3 space-y-8 text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
          {/* Section 1 */}
          <section id="collection" className="bg-white dark:bg-[#121e21] border border-slate-100 dark:border-[#1e2e30] rounded-2xl p-6 sm:p-8 shadow-xs">
          ...
          {/* Section 2 */}
          <section id="usage" className="bg-white dark:bg-[#121e21] border border-slate-100 dark:border-[#1e2e30] rounded-2xl p-6 sm:p-8 shadow-xs">
            <h2 className="text-xl font-bold text-[#091e22] dark:text-[#f1f5f9] mb-4 flex items-center gap-2">
          ...
          {/* Section 3 */}
          <section id="sharing" className="bg-white dark:bg-[#121e21] border border-slate-100 dark:border-[#1e2e30] rounded-2xl p-6 sm:p-8 shadow-xs">
            <h2 className="text-xl font-bold text-[#091e22] dark:text-[#f1f5f9] mb-4 flex items-center gap-2">
          ...
          {/* Section 4 */}
          <section id="security" className="bg-white dark:bg-[#121e21] border border-slate-100 dark:border-[#1e2e30] rounded-2xl p-6 sm:p-8 shadow-xs">
            <h2 className="text-xl font-bold text-[#091e22] dark:text-[#f1f5f9] mb-4 flex items-center gap-2">
          ...
          {/* Section 5 */}
          <section id="rights" className="bg-white dark:bg-[#121e21] border border-slate-100 dark:border-[#1e2e30] rounded-2xl p-6 sm:p-8 shadow-xs">
            <h2 className="text-xl font-bold text-[#091e22] dark:text-[#f1f5f9] mb-4 flex items-center gap-2">
          ...
          {/* Section 6 & 7 */}
          <section id="cookies" className="bg-white dark:bg-[#121e21] border border-slate-100 dark:border-[#1e2e30] rounded-2xl p-6 sm:p-8 shadow-xs">
            <h2 className="text-xl font-bold text-[#091e22] dark:text-[#f1f5f9] mb-4 flex items-center gap-2">
          ...
          <section id="thirdparty" className="bg-white dark:bg-[#121e21] border border-slate-100 dark:border-[#1e2e30] rounded-2xl p-6 sm:p-8 shadow-xs">
            <h2 className="text-xl font-bold text-[#091e22] dark:text-[#f1f5f9] mb-4 flex items-center gap-2">
          ...
          {/* Section 8 */}
          <section id="contact" className="bg-white dark:bg-[#121e21] border border-slate-100 dark:border-[#1e2e30] rounded-2xl p-6 sm:p-8 shadow-xs">
            <h2 className="text-xl font-bold text-[#091e22] dark:text-[#f1f5f9] mb-4 flex items-center gap-2">
